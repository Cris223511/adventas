...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['ventas'] == 1) {
    ...
    $rsptav = $venta_servicio->ventacabecera($_GET["id"]);
    ...
    while ($regd = $rsptad->fetch_object()) {
      $line = array(
        ...
        "NOMBRE DE PRODUCTO" => utf8_decode("$regd->servicio"),
    ...
    $pdf->Output('Reporte de Venta de Servicio.pdf', 'I');
  } else {
