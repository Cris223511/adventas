...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['escritorio'] == 1) {
    ...
    if ($cargo == "superadmin") {
      ...
      $rsptac = $consulta->totalcomprahoyUsuario($idusuario);
      $rsptav = $consulta->totalventahoyUsuario($idusuario);
      $compras10 = $consulta->comprasultimos_10diasUsuario($idusuario);
      $ventas12 = $consulta->ventasultimos_12mesesUsuario($idusuario);
    }
