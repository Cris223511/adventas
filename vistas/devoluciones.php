            ...
            <form name="formulario4" id="formulario4" method="POST">
              ...
              <div class="row" style="padding-left: 15px; padding-right: 15px;">
                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                  ...
                  <input type="text" class="form-control" name="codigo_pedido" id="codigo_pedido3" maxlength="10" placeholder="Cargando..." disabled>
                </div>
                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                  <label style="width: 125px;">Teléfono(*):</label>
                  <input type="number" class="form-control" name="telefono" id="telefono3" maxlength="9" placeholder="Cargando..." disabled>
                </div>
                <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                  ...
                  <input type="text" class="form-control" name="empresa" id="empresa3" maxlength="50" placeholder="Cargando..." disabled>
                </div>
                <hr>
              ...
              <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 table-responsive" style="overflow-x: visible;">
                <table id="detalles3" class="table table-striped table-bordered table-condensed table-hover w-100" style="width: 100% !important">
    ...
    <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog" style="width: 90% !important; max-height: 95vh; margin: 0 !important; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%); overflow-x: hidden;">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title infotitulo">Solicitar devolución:</h4>
          </div>
          <div class="panel-body">
          ...
          <div class="panel-body">
            <form name="formulario" id="formulario" method="POST">
              ...
              <div class="row" style="padding-left: 15px; padding-right: 15px;">
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                  <label style="width: 125px;">Teléfono(*):</label>
                  <input type="number" class="form-control" name="telefono" id="telefono" placeholder="Cargando..." disabled>
                </div>
                <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                  <label class="label_serie">Empresa(*):</label>
                  <input type="text" class="form-control" name="empresa" id="empresa" maxlength="50" placeholder="Cargando..." disabled>
                </div>
              </div>
