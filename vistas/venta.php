...
?>
    ...
    <!-- Modal 3 -->
    <div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 9999;">
      <div class="modal-dialog" style="width: 95% !important; max-height: 95vh; margin: 0 !important; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%); overflow-x: hidden;">
        <div class="modal-content">
          ...
          <div class="panel-body">
            <form name="formulario4" id="formulario4" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group col-lg-10 col-md-9 col-sm-12 caja2" style="background-color: white; border-top: 3px #3d3f3f solid; padding: 20px; margin: 0;">
                ...
                <div class="form-group col-lg-6 col-md-6 col-sm-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                  ...
                  <select id="idalmacen4" name="idalmacen" class="form-control selectpicker" data-live-search="true" data-size="5" onchange="actualizarRUC4()" required>
                ...
                <div class="form-group col-lg-12 col-md-6 col-sm-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                  ...
                  <input type="text" class="form-control" name="descripcion" id="descripcion5" placeholder="Descripción del artículo" autocomplete="off">
                </div>
                <div class="form-group col-lg-12 col-md-6 col-sm-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
        ...
        <div class="modal-content">
          ...
          <div class="panel-body">
            ...
            <form name="formulario2" id="formulario2" method="POST">
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <label>Descripción:</label>
                <input type="text" class="form-control" name="descripcion" 5 maxlength="50" placeholder="Ingrese la descripción del cliente." autocomplete="off" disabled>
              </div>
