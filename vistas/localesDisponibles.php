              ...
              <div class="panel-body" style="height: max-content;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="text" class="form-control" name="ubicacion" id="ubicacion" maxlength="40" placeholder="Ingrese la ubicación del local." autocomplete="off" required>
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <label>RUC(*):</label>
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <img src="" width="150px" id="imagenmuestra" style="margin-top: 20px;">
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="panel-body" style="height: max-content;" id="formularioasignacion">
                <form name="formulario2" id="formulario2" method="POST">
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select id="idalmacen_asignar" name="idalmacen_asignar" class="form-control selectpicker" data-live-search="true" data-size="5" required>
