...
?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Ventas de servicios
      ...
      <div class="modal-dialog" style="width: 90% !important; max-height: 80%; margin: 0 !important; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%); overflow-x: hidden;">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title infotitulo">Registrar venta de servicio:</h4>
          </div>
          <div class="panel-body">
            <form name="formulario" id="formulario" method="POST">
              ...
              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex; flex-direction: row; gap: 10px; align-items: center;">
                ...
                <input type="hidden" name="idventa_servicio" id="idventa_servicio">
              ...
              <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12" id="form_codigo_barra" style="float: right;">
                <label style="float: left;">Buscar por código de servicio: <a href="#" data-toggle="popover" data-placement="top" title="Buscar por código de servicio" data-content="Sólo se listan los servicios que están activados." style="color: #418bb7"><i class="fa fa-question-circle"></i></a></label>
                <select id="idservicio" name="idservicio" class="form-control selectpicker" data-size="6" data-live-search="true" onchange="llenarTabla()">
              ...
              <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-12" style="float: left; margin-top: 20px;">
                <a data-toggle="modal" href="#myModal">
                  <button id="btnAgregarArt" type="button" class="btn btn-secondary" style="color: black !important"> <span class="fa fa-plus"></span> Agregar servicio</button>
                </a>
              </div>
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/ventaServicio.js"></script>
<?php
}
ob_end_flush();
?>